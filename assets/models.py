...
class server(models.Model):
    ...
    hosted_on = models.ForeignKey('self',related_name='hosted_on_server',blank=True,null=True,verbose_name='服务器型号',on_delete=models.CASCADE)
...
class NetworkDevice(models.Model):
    ...
    model = models.CharField(max_length=128,blank=True,null=True,verbose_name='网络设备型号')
...
class Software(models.Model):
    ...
    license_num = models.ImageField(default=1,verbose_name='授权数量')
