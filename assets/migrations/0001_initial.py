# Generated by Django 2.1 on 2018-09-03 11:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('sofeware', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
                ('hosted_on', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hosted_on_server', to='assets.server', verbose_name='服务器型号')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_num', models.ImageField(default=1, upload_to='', verbose_name='授权数量')),
